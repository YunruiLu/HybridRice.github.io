...
async function query() {
    ...
    try {
        ...
        if (result) {
            ...
            ezhouHtml += '<table><tr><th>Property</th><th>Value</th></tr>';
            const ezhouKeys = ['P1', 'P2'].concat(allKeys.filter(key => key.startsWith('E')));
            ...
            sanyaHtml += '<table><tr><th>Property</th><th>Value</th></tr>';
            const sanyaKeys = ['P1', 'P2'].concat(allKeys.filter(key => key.startsWith('S')));
